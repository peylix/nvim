...
add({
  ...
  Config.gh("nvim-treesitter/nvim-treesitter-context"),
})
...
-- mason.nvim
add({ Config.gh("mason-org/mason.nvim") })
...
-- nvim-lint
add({ Config.gh("mfussenegger/nvim-lint") })
...
if not Config.profile_is_reduced then
  ...
  autocmd("FileType", {
    ...
    callback = function()
      add({
        {
          src = Config.gh("chomosuke/typst-preview.nvim"),
